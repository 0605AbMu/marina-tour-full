...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Trip>().Property(x => x.CreatedAt).ValueGeneratedOnAdd().HasDefaultValueSql("now()");
        modelBuilder.Entity<Trip>().Property(x => x.UpdatedAt).ValueGeneratedOnAddOrUpdate()
            .HasDefaultValueSql("now()");

        modelBuilder.Entity<Order>().Property(x => x.CreatedAt).ValueGeneratedOnAdd().HasDefaultValueSql("now()");
        ;
